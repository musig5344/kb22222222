...
const legacyColors = {
  ...
  kbYellowPressed: colors.brand.pressed,
  ...
  // Status colors
  error: colors.functional.expense,
  success: colors.functional.income,
  ...
  errorRed: colors.functional.expense,
  accentBlue: colors.functional.income,
  successGreen: colors.functional.income,
  ...
  buttonYellowPressed: colors.brand.pressed,
