...
/**
 * 버튼 크기별 스타일 - Universal responsive design
 */
export const buttonSizes: Record<ButtonSize, ReturnType<typeof css>> = {
  small: css`
    height: ${responsiveSizes.button.heightSmall};
  ...
  xl: css`
    height: ${responsiveSizes.button.heightLarge};
    padding: 0 ${responsiveSpacing.xl};
    ${responsiveTypography.labelLarge}
    font-weight: ${tokens.typography.fontWeight.bold};
    min-width: 140px;
    border-radius: ${responsiveSizes.button.borderRadius};
  ...
  `,
  keypad: css`
    height: ${responsiveSizes.touchTarget.recommended};
    width: ${responsiveSizes.touchTarget.recommended};
    padding: 0;
...
/**
 * 스타일드 버튼 컴포넌트 - Universal responsive design
 */
export const StyledButton = styled.button<ButtonProps>`
  ${universalButton}
  
  /* 기본 스타일 override for KB design */
