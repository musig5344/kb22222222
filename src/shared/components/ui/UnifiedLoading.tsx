...
import { useLoadingAnimation, LoadingAnimationType } from '../../../hooks/useLoadingAnimation';
...
export const UnifiedLoading: React.FC<UnifiedLoadingProps> = memo(({
  ...
  const { currentFrame, isPlaying } = useLoadingAnimation({ 
    type: variant, 
    frameRate: 80,
    autoStart: isVisible
  });
