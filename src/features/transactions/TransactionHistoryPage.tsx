...
// 페이지네이션 버튼
const PaginationButton = styled.button<{ $isActive?: boolean; $isArrow?: boolean }>`
  min-width: ${tokens.sizes.touch.minimum};
  min-height: ${tokens.sizes.touch.minimum};
  padding: ${tokens.spacing[2]} ${tokens.spacing[3]};
  border: 1px solid ${props => props.$isActive ? '#FFD338' : '#E5E5EA'};
  background: ${props => props.$isActive ? '#FFD338' : tokens.colors.background.primary};
  color: ${props => props.$isActive ? '#000000' : tokens.colors.text.primary};
  ...
  &:hover:not(:disabled) {
    background: ${props => props.$isActive ? '#FFD338' : '#F5F5F5'};
