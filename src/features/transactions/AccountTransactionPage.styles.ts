...
// 헤더 관련 스타일 (comprehensive-account와 동일한 구조)
...
export const AccountDropdown = styled.div`
  ...
  padding: ${responsiveSpacing.md} 0;
...
export const AccountIcon = styled.div`
  ...
  img {
    width: ${responsiveSizes.icon.small};
    height: ${responsiveSizes.icon.small};
    object-fit: contain;
  }
`;
...
export const Balance = styled.div`
  text-align: right;
  margin-top: ${responsiveSpacing.lg};
`;

export const BalanceAmount = styled.div`
  ${responsiveTypography.numberLarge}
  color: #000000;
  margin-bottom: ${responsiveSpacing.xs};
`;
...
export const TransactionList = styled.div`
  ...
  background: #ffffff;
  padding: 0;
  padding-top: 0; /* Override universal main content top padding */
...
export const DetailInfoValue = styled.div<{ $isAmount?: boolean; $isPositive?: boolean }>`
  ...
  color: ${props => 
    props.$isAmount 
      ? (props.$isPositive ? '#4285F4' : '#FF6B6B')
      : '#000000'
  };
  text-align: right;
`;
